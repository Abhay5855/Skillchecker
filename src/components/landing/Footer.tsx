...
const Footer = () => {
	...
	// Item variants for smooth reveal
	const itemVariants = {
			...
			<div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
				...
				>
					...
					>
						...
						>
							Revolutionizing online testing with live monitoring and real-time
							feedback.
						</motion.p>
				...
				>
					...
					>
						© 2024 Skillscope. All rights reserved.
					</motion.p>
				</motion.div>
			</div>
		</motion.footer>
